<template>
    <div class="container">
      <!-- Angyalok gomb -->
      <a :href="links.angyalok" class="button angyalok">Angyalok</a>
  
      <!-- Halandók gomb -->
      <a :href="links.halandok" class="button halandok">Halandók</a>
  
      <!-- Démonok gomb -->
      <a :href="links.demonok" class="button demonok">Démonok</a>
    </div>
  </template>
  ...
  export default {
    data() {
      return {
        links: {
          angyalok: 'angyalok.html',
          halandok: 'halandok.html',
          demonok: 'demonok.html'
        }
      };
    }
  };
  ...
  @keyframes angel-pulse {
    ...
    50% {
      box-shadow: 0 6px 15px rgba(173, 216, 230, 1);
    }
  }
  
  /* Démonok animáció */
  @keyframes demon-flame {
    0%, 100% {
      box-shadow: 0 4px 10px rgba(139, 0, 0, 0.8);
    }
    50% {
      box-shadow: 0 6px 15px rgba(255, 69, 0, 1);
    }
  }
  ...
  @keyframes mortal-pulse {
    ...
    50% {
      box-shadow: 0 6px 15px rgba(160, 82, 45, 1);
    }
  }
  </style>
